    ...
    public function run(): void
    {
        ...
        $materiais = [
            ...
            [
                ...
                'tipo' => 'video',
                'video_url' => 'https://www.youtube.com/watch?v=8-li9rAzi-s',
                'apenas_vip' => false,
                'ativo' => true,
                'criado_por' => $admin->id,
            ],
            [
                ...
                'categoria' => 'financeiro',
                'tipo' => 'video',
                'video_url' => 'https://www.youtube.com/watch?v=2LJrPb8BuEE',
                'apenas_vip' => true,
                'ativo' => true,
                'criado_por' => $admin->id,
            ],
            ...
            [
                ...
                'categoria' => 'pessoas',
                'tipo' => 'video',
                'video_url' => 'https://www.youtube.com/watch?v=kBMzvq-E0ow',
                'apenas_vip' => false,
                'ativo' => true,
                'criado_por' => $admin->id,
            ],
            [
                ...
                'categoria' => 'pessoas',
                'tipo' => 'video',
                'video_url' => 'https://www.youtube.com/watch?v=Yj0l7iGKh8g',
                'apenas_vip' => true,
                'ativo' => true,
                'criado_por' => $admin->id,
            ],
            ...
            [
                ...
                'categoria' => 'cardapio',
                'tipo' => 'video',
                'video_url' => 'https://www.youtube.com/watch?v=xRQVVSx1VNY',
                'apenas_vip' => true,
                'ativo' => true,
                'criado_por' => $admin->id,
            ],
            [
                ...
                'categoria' => 'cardapio',
                'tipo' => 'video',
                'video_url' => 'https://www.youtube.com/watch?v=Sf298ozgDNI',
                'apenas_vip' => false,
                'ativo' => true,
                'criado_por' => $admin->id,
            ],
            ...
            [
                ...
                'tipo' => 'video',
                'video_url' => 'https://www.youtube.com/watch?v=pCz-BQ92w1Y',
                'apenas_vip' => false,
                'ativo' => true,
                'criado_por' => $admin->id,
            ],
            ...
            [
                ...
                'categoria' => 'marketing',
                'tipo' => 'video',
                'video_url' => 'https://www.youtube.com/watch?v=kqVAhBNVmII',
                'apenas_vip' => false,
                'ativo' => true,
                'criado_por' => $admin->id,
            ],
            [
                ...
                'categoria' => 'marketing',
                'tipo' => 'video',
                'video_url' => 'https://www.youtube.com/watch?v=W_wBT36x0qA',
                'apenas_vip' => true,
                'ativo' => true,
                'criado_por' => $admin->id,
            ],
            ...
            [
                ...
                'tipo' => 'video',
                'video_url' => 'https://www.youtube.com/watch?v=zVDQs8cxH48',
                'apenas_vip' => false,
                'ativo' => true,
                'criado_por' => $admin->id,
            ],
            ...
            [
                ...
                'categoria' => 'logistica',
                'tipo' => 'video',
                'video_url' => 'https://www.youtube.com/watch?v=9YaP9b9ct7c',
                'apenas_vip' => false,
                'ativo' => true,
                'criado_por' => $admin->id,
            ],
            [
                ...
                'categoria' => 'logistica',
                'tipo' => 'video',
                'video_url' => 'https://www.youtube.com/watch?v=fFLVyJEG5RQ',
                'apenas_vip' => true,
                'ativo' => true,
                'criado_por' => $admin->id,
            ],
            ...
            [
                ...
                'categoria' => 'inovacao',
                'tipo' => 'video',
                'video_url' => 'https://www.youtube.com/watch?v=R3CdopLgg6Q',
                'apenas_vip' => true,
                'ativo' => true,
                'criado_por' => $admin->id,
            ],
            [
                ...
                'categoria' => 'inovacao',
                'tipo' => 'video',
                'video_url' => 'https://www.youtube.com/watch?v=TvQViPBAnmE',
                'apenas_vip' => false,
                'ativo' => true,
                'criado_por' => $admin->id,
            ],
