...
class DadosTesteSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $user9 = UserModel::create([
            ...
            'status' => 'aprovado',
            'plano' => 'vip',
            'telefone' => '(27) 3258-6677',
            'whatsapp' => '(27) 99000-8877',
            'cidade' => 'Serra',
            'aprovado_por' => 1,
