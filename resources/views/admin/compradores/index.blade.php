                        ...
                        <div class="flex-1 min-w-0 overflow-hidden">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-2 text-sm mb-3">
                                ...
                                <div class="flex items-center gap-1 min-w-0">
                                    ...
                                    <span class="text-[var(--cor-texto-muted)] truncate">{{ $comprador->whatsappPrincipal?->formatado() ?? 'N/A' }}</span>
                                </div>
                                <div class="flex items-center gap-1 min-w-0">
                                    <i data-lucide="map-pin" class="w-4 h-4 flex-shrink-0 text-gray-400"></i>
                                    <span class="text-[var(--cor-texto-muted)] truncate">{{ $comprador->enderecoPrincipal?->cidade ?? 'N/A' }}</span>
                                </div>
                            </div>
